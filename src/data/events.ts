...
export default new FarmCategory(
    ...
    [
        new Farm(
            ...
            'dark',
            [
                new FarmUnit('Second Sister', 7, 13, 5, 230),
                new FarmUnit('Ninth Sister', 7, 13, 5, 231),
                new FarmUnit('Seventh Sister', 7, 13, 5, 234),
                new FarmUnit('Eighth Brother', 7, 13, 5, 235),
                new FarmUnit('Fifth Brother', 7, 13, 5, 238),
            ],
            [],
        ),
        new Farm(
